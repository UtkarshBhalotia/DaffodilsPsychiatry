...
public class CombinedCourseFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        root = inflater.inflate(R.layout.lyt_combined_course, container, false);
                ...
                alertDialog.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        try {
                            ...
                            if (!GlobalConst.User_id.isEmpty()){
                                //call web service
                                addToCartService(GlobalConst.CModule1ID, GlobalConst.AnyModule);
                ...
                alertDialog.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        try {
                            ...
                            if (!GlobalConst.User_id.isEmpty()){
                                //call web service
                                addToCartService(GlobalConst.CModule2ID, GlobalConst.AnyModule);
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        try {
                            ...
                            if (!GlobalConst.User_id.isEmpty()){
                                ...
                                addToCartService(GlobalConst.CModule3ID, GlobalConst.AnyModule);
                            } else {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        try {
                            ...
                            if (!GlobalConst.User_id.isEmpty()){
                                ...
                                addToCartService(GlobalConst.CModule4ID, GlobalConst.AnyModule);
                            } else {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        try {
                            if (!GlobalConst.User_id.isEmpty()){
                                ...
                                addToCartService(GlobalConst.CModule5ID, GlobalConst.AnyModule);
                            } else {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        try {
                            if (!GlobalConst.User_id.isEmpty()){
                                ...
                                addToCartService(GlobalConst.CModule6ID, GlobalConst.AnyModule);
                            } else {
...
//        });
    ...
    public void onResume() {
        super.onResume();
        GlobalConst.TOOLBAR_TITLE = getString(R.string.title_combinedcourse);
