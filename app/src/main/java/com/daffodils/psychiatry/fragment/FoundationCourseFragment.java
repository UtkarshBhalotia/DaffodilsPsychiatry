...
public class FoundationCourseFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        txtFullCourseDuration.setText("Full Foundation Course (Old Ver.) : " + GlobalConst.FULL_COURSE_DURATION);
        ...
        txtSubsFullCourse.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                alertDialog.setTitle("Add To Cart Full Foundation Course ?");
                alertDialog.setMessage("Do you want to add Full Foundation Course to Cart ?");
